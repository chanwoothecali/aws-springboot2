...
public class PostsApiControllerTest {
    ...
    public void Posts를_불러온다() {
        ...
        try{
            Object parse = new JSONParser().parse(responseEntity.getBody());
            JSONObject jsonObject = (JSONObject) parse;
            assertThat(jsonObject.get("title")).isEqualTo(savedPosts.getTitle());
            assertThat(jsonObject.get("content")).isEqualTo(savedPosts.getContent());
        }catch (Exception e) {
